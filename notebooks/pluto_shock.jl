...
# ╔═╡ 08449260-75a5-11ef-0118-63f6da5b28cd
begin
	using Euler2D
	using LaTeXStrings
	using LinearAlgebra
...
# ╔═╡ df491bd1-8fe1-4762-a60c-d76c6b141f93
try
    include("shock2d.jl")
catch Exception e
    println(e)
...
# ╔═╡ 5a02a124-b429-4970-89b3-355dfc4baf00
#version 0.9.0
#18.09.24

# ╔═╡ 9a378618-936b-4107-b6f4-9452b76ada95
...
# ╔═╡ 736befd4-70f4-4aee-ae0d-be81e28fe22f

#loading tape
begin
	FILENAME = "dataSim/sod_shock_orb.tape"
...
# ╔═╡ a2da3a98-6ca3-426f-b2c1-40e0c7e1e175
#bind to something later

@bind frame Slider(1:data.nsteps)


# ╔═╡ 13f2fefc-5ebc-4d05-b90a-ac370473bdc9
#find shock points
#d2p, d1p according to article. 
d1p1 = delta_1p(frame, data);

# ╔═╡ 8dc77593-2d7f-4a09-844b-ebaeb687d89a
d2p = delta_2p(frame, data);

# ╔═╡ 3fc06fae-e1e8-4243-b0e8-e9cf143146b8
blanked = blank(d1p1, d2p, 0.15, 10e-5);

# ╔═╡ 5592e0f7-7cfb-469d-bd16-2abfb9d30ece
begin
...
# ╔═╡ 80831331-bc60-4807-95fd-1b37de37c5c7
...
# ╔═╡ 07332e37-d3a9-4950-825c-05724baff3b3
#PLOTTING

# ╔═╡ a675c692-33a9-4bf3-be58-12abd2c10446
begin
...
# ╔═╡ f9eb1b05-ee69-491c-aacb-9e88df0f6e5a
begin
		#Plotting
...
# ╔═╡ 51840907-c069-4a27-a481-04a291946c83
begin
	#Plotting
...
# ╔═╡ 1c50f6fc-65ff-4fb0-b7a4-115223c34ba9
begin
		shockplot = scatter(
...
# ╔═╡ 37f34c57-3c67-466e-956c-f174b8de0994
...
manifest_format = "2.0"
project_hash = "fa35882876e647cc6bf5491253870a5ac69deefa"
...
git-tree-sha1 = "7f1e914e25c5c6097a3d38b4179d97e389452d26"
...
git-tree-sha1 = "e590eb8d806e8fa3176dce71ac51a6f3dddfed2a"
...
git-tree-sha1 = "622a71810129fc8533da7ea6a4b9aed525aae0f8"
